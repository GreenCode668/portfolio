...
export default function Hero() {
  const words = [
    ...
    "Blockchain Developer & Creator of Olova.js",
...
const profile = {
    ...
    skills: [
        'React', 'NextJS', 'Vue', 'Express', 'Laravel',
        'MySQL', 'MongoDB', 'Docker', 'AWS', 'TypeScript',
        'GraphQL', 'Git', 'Linux', 'Blockchain'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/GreenCode8668"
                ...
                {/* Contact Button */}
                <a
                  href="/JuanDelaCruzResume.pdf"
                  download="JuanDelaCruzResume.pdf"
